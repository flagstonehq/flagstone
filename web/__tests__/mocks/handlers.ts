      ...
      segments: [
        {
          ...
          rules: { attribute: "plan", op: "eq", value: "beta" },
          archived_at: null,
          created_at: new Date(Date.now() - 604800000).toISOString(),
          updated_at: new Date().toISOString(),
        },
        {
          ...
          rules: { attribute: "plan", op: "eq", value: "premium" },
          archived_at: null,
        ...
        },
        {
          ...
          rules: { attribute: "email", op: "ends_with", value: "@acme.com" },
  ...
  http.put(`${API_BASE}/api/v1/projects/:slug/segments/:key`, async ({ request, params }) => {
    ...
    return HttpResponse.json({
      segment: {
        ...
        rules: body.rules ?? { attribute: "plan", op: "eq", value: "beta" },
        archived_at: null,
        created_at: new Date(Date.now() - 604800000).toISOString(),
        updated_at: new Date().toISOString(),
      },
